...
func init() {
	...
	uninstallCmd.Flags().StringVar(&cfg.DeployManifestsDirectory, "deploy-manifests-dir", "manifests/deploy", "The absolute/relative path to the metering manfiest directory. This can also be specified through the INSTALLER_MANIFESTS_DIR")
